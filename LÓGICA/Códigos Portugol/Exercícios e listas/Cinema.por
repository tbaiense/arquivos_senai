		...
		faca {
		   ...
		   faca {
			...
			se (filmePermitido(idade, filmeEscolhido))
			{
				...
				escreva("FILME NÃO PERMITIDO PARA SUA IDADE.\n Escolha outro!")
			}
			} enquanto ((filmeEscolhido >= 7) ou (filmeEscolhido <= 0) ou (nao filmePermitido(idade, filmeEscolhido)))
			limpa()
		   ...
		   faca {
			   ...
			   escreva("\n      1 - SIM , 2 - NÃO      \n")
			   leia(input)
		   } enquanto (nao Tipos.cadeia_e_inteiro(input, 10) ou Tipos.cadeia_para_inteiro(input, 10) == 0 ou (Tipos.cadeia_para_inteiro(input, 10) != 2 e Tipos.cadeia_para_inteiro(input, 10) != 1))
 ...
 * 
 * @POSICAO-CURSOR = 3645; 
 * @DOBRAMENTO-CODIGO = [4, 13, 20, 27, 34, 51, 62, 69, 95, 155, 161];
 * @PONTOS-DE-PARADA = ;
