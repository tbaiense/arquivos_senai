...
/** Um objeto CPF representa o número de Cadastro de Pessoa Física,
 * que é composto por 11 dígitos ao total, sendo os últimos 2 digitos
 * usados para a verificação dos anteriores. Um CPF pode ser informado
 * apenas com os dígitos ou com os dígitos e pontuação, no formato
